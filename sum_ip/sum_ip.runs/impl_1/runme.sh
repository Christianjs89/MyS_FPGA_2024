...
HD_PWD='C:/Users/chris/Documents/FPGA/sum_ip/sum_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_system_wrapper.tcl -notrace
