...
HD_PWD='C:/Users/chris/Documents/FPGA/sum_ip/sum_ip.runs/sum_system_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_system_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_system_auto_pc_0.tcl
