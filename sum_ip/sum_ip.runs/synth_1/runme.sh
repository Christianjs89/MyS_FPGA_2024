...
HD_PWD='C:/Users/chris/Documents/FPGA/sum_ip/sum_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_system_wrapper.tcl
