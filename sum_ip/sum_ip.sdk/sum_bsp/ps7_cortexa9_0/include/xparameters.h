...
/* Definitions for driver SUM_IP */
#define XPAR_SUM_IP_NUM_INSTANCES 1

/* Definitions for peripheral SUM_IP */
#define XPAR_SUM_IP_DEVICE_ID 0
#define XPAR_SUM_IP_S_AXI_BASEADDR 0x43C00000
#define XPAR_SUM_IP_S_AXI_HIGHADDR 0x43C0FFFF
