...
/* Definitions for peripheral LED_PIN */
#define XPAR_LED_PIN_DEVICE_ID 0
#define XPAR_LED_PIN_S_AXI_BASEADDR 0x43C00000
#define XPAR_LED_PIN_S_AXI_HIGHADDR 0x43C0FFFF
