...
HD_PWD='C:/Users/chris/Documents/FPGA/negador/negador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log negador_vio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source negador_vio.tcl -notrace
