...
HD_PWD='C:/Users/chris/Documents/FPGA/negador/negador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log negador_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source negador_vio.tcl
