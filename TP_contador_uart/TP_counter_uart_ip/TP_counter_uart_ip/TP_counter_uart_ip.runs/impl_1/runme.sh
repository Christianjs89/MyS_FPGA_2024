...
HD_PWD='C:/Users/chris/Documents/FPGA/TP_contador_uart/TP_counter_uart_ip/TP_counter_uart_ip/TP_counter_uart_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_system_wrapper.tcl -notrace
