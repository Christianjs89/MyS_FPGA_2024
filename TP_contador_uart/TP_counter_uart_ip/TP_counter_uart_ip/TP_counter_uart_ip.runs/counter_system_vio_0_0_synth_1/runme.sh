...
HD_PWD='C:/Users/chris/Documents/FPGA/TP_contador_uart/TP_counter_uart_ip/TP_counter_uart_ip/TP_counter_uart_ip.runs/counter_system_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_system_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_system_vio_0_0.tcl
