...
#
# Generated by export_simulation on Sat Dec 07 14:55:04 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './counter_system.sh' script.

./counter_system.sh -reset_run
...
./counter_system.sh -noclean_files

For more information on the script, please type './counter_system.sh -help'.
